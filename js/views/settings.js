...
import { state, commit, exportJson, importJson, scheduleZones, shiftSchedules, stampSchedules, listBackups, readBackup, activeHabits} from '../store.js';
...
export function renderSettings(root, { navigate }) {
  ...
  /* ---------- Steps from the phone ----------
     Health is the phone's; a Shortcut reads it and posts the day's steps to
     the health-steps function with a token made here. The goal and the
     habit sync; the token lives on the server, in your row. */
